...
public class SplashActivity extends Activity{
	...
	private String componentName = "com.rms_member";
	private String componentActivityName = "com.rms_member.MainActivity";
	...
	private class CheckVersionTask implements Runnable{
		...
		public void run() {
			...
			String serverUrl = UrlAddress.url + "uploads/app/update-member.xml";
